<template>
  <div class="home-view">
    <header class="w-100">
      <div class="header_content_block container">
        ...
        <div class="header_content_info">
          <div class="row">
            <div class="col d-flex justify-content-center header_content_info_preview p-0">
            ...
            <div class="col header_content_info_forms">
              ...
              <div class="header_content_info_calculate_block w-100 d-flex align-items-start flex-column">
                ...
                <div class="header_content_info_calculate_forms_block w-100 d-flex justify-content-between">
                  <default-input class="header_content_info_calculate_form_input_size" placeholder="Откуда"
                    :title="true" />
